...
class PendingAdsCards extends StatelessWidget {
  ...
  PendingAdsCards({this.onTap,required this.img, required this.text, required this.price, required this.icon, required this.location, required this.time, required this.timeIcon});
