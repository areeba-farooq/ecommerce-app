...
class HiddenAdsCards extends StatelessWidget {
  ...
  HiddenAdsCards({this.onTap,required this.img, required this.text, required this.price, required this.icon, required this.location, required this.time, required this.timeIcon});
