...
class TrendingAdsList extends StatefulWidget {
  @override
  _TrendingAdsListState createState() => _TrendingAdsListState();
}

class _TrendingAdsListState extends State<TrendingAdsList> {
  int currentTab = 6;
  Widget currentScreen = TrendingAdsList();
